...
def benchmark_exclusao_counter(palavras, alvos):
    estrutura = Counter(palavras)
    inicio = time.perf_counter()
    for alvo in alvos:
        estrutura.pop(alvo, None)
    return time.perf_counter() - inicio


def benchmark_exclusao_ordered_dict(palavras, alvos):
...
def benchmark_exclusao_defaultdict(palavras, alvos):
...
def main():
    ...
    tempo_counter = benchmark_exclusao_counter(palavras, alvos)
    tempo_ordered = benchmark_exclusao_ordered_dict(palavras, alvos)
    tempo_defaultdict = benchmark_exclusao_defaultdict(palavras, alvos)
